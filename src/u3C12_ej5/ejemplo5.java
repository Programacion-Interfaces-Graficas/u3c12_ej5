...
public class ejemplo5 {	
	public static void main(String[] args) {
     ...
     // Bucle que se ejecuta mientras alguno de los hilos siga vivo.
        while (hilo1.hilo.isAlive() || hilo2.hilo.isAlive() || hilo3.hilo.isAlive()) {
            // Aquí se puede realizar otras tareas mientras esperas que los hilos terminen
            System.out.println("Esperando...");
            try {
            	// Hace que el hilo principal duerma por medio segundo (500 milisegundos) antes de verificar nuevamente.
                Thread.sleep(500); 
            } catch (InterruptedException e) {
